...
urlpatterns = [
    ...
    path('paid/', views.index_paid_receipt, name='paid'),
    ...
    path('paid/addpr/', views.view_paid_receipt.add_paid_receipt, name='add_paid_receipt'),
    path("paid/delpr/", views.view_paid_receipt.del_paid_receipt, name="del_paid_receipt"),
    path("paid/uppr/", views.view_paid_receipt.update_paid_receipt, name="update_paid_receipt"),
